    ...
    WA.event.on("ping").subscribe((value) => {
      if (value.data === "start") {
        ...
        const endTranslations = {
          ...
          "fr-FR":
            "Aucune phase de groupe n'est actuellement active. S'il te plaît, rassemble-toi à nouveau avec tous les autres.",
          "it-IT":
            "Al momento non è attiva alcuna fase di gruppo. Si prega di riunirsi di nuovo con tutti gli altri.",
          "pt-BR":
            "Nenhuma fase de grupo está ativa no momento. Por favor, reúna-se novamente com todos os outros.",
          "es-ES":
            "Actualmente no hay ninguna fase de grupo activa. Por favor, reúnanse de nuevo con todos los demás.",
          "zh-CN": "目前没有活跃的小组阶段。请与其他人重新组合。",
          "ar-SA":
            "لا توجد مرحلة مجموعة نشطة حاليًا. يرجى التجمع مرة أخرى مع الجميع.",
          "de-DE":
